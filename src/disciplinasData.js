// Datos de las disciplinas del Metaverso Educativo
export const disciplinas = [
    {
      ...
      colorTema: '#00FF41', // Verde Neón
      avataresDisponibles: 3
    },
    {
      id: 'chronos',
    ...
    },
    {
      ...
      colorTema: '#00FFFF', // Azul Cian
      avataresDisponibles: 2
    },
    {
      id: 'bio_genesis',
      titulo: 'BIO GÉNESIS',
      subtitulo: 'Ciencias Biológicas',
      icono: '🧬',
      descripcion: 'Explora el microcosmos y los ecosistemas. Interactúa con células y cadenas de ADN usando movimientos precisos.',
      colorTema: '#FF00FF', // Magenta Neón
      avataresDisponibles: 3
    },
    {
      id: 'lingua',
      titulo: 'NEXO LINGÜÍSTICO',
      subtitulo: 'Lenguajes',
      icono: '🗣️',
      descripcion: 'Español e Inglés. Participa en diálogos interactivos y desafíos gramaticales usando gestos y postura.',
      colorTema: '#FF4500', // Naranja Neón
      avataresDisponibles: 2
    }
  ];
